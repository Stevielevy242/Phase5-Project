...
const CompanyMsgScreen = ({route}) => {
    ...
    function get_msgs() {
      fetch(`http://localhost:3001/messages/${route.params.investor_id}/${currentCompany.id}`)
        .then(res => res.json())
    ...
    function sendMessage(){
      fetch('http://localhost:3001/messages', {
        ...
        body: JSON.stringify({
          "text": input,
          "sent_by_user" : false,
          "investor_id": route.params.investor_id, 
    ...
    // console.log(route.params.investor_id) 
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Header title={route.params.investor_name} callEnabled backArrow/>
...
export default CompanyMsgScreen
